...
public class Boundaries implements ForwardingProfile.OsmRelationPreprocessor, ForwardingProfile.FeatureProcessor, ForwardingProfile.FeaturePostProcessor {
    ...
    public void processFeature(SourceFeature sf, FeatureCollector features) {
        if (sf.canBeLine()) {
            ...
            if (recs.size() > 0) {
                ...
                var line = features.line(this.name()).setMinPixelSize(0).setAttr("pmap:min_admin_level",minAdminLevel.getAsInt());
