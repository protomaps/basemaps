...
const Toner = (variant:string):[any,Rule[],LabelRule[],string] => {
    ...
    let paint_rules:Rule[] = [
        ...
        },
        {
            ...
            filter: (z,f) => { return f.props.leisure == "park" }
        },
        {
            dataLayer: "water",
            symbolizer: new PolygonSymbolizer({
        ...
        },
        {
            ...
            filter: (z,f) => { return f.props["pmap:kind"] === "minor_road" }
        },
        {
            dataLayer: "roads",
            symbolizer: new LineSymbolizer({
            ...
            filter: (z,f) => { return f.props["pmap:kind"] === "medium_road" }
        },
        {
            dataLayer: "roads",
            symbolizer: new LineSymbolizer({
        ...
        },
        {
            ...
            filter: (z,f) => { return f.props["pmap:kind"] === "major_road" }
        },
        {
            dataLayer: "roads",
            symbolizer: new LineSymbolizer({
        ...
        },
        {
            ...
            filter: (z,f) => { return f.props["pmap:kind"] === "highway" }
        },
        {
            dataLayer: "roads",
            symbolizer: new LineSymbolizer({
        ...
        },
        {
            ...
            filter: (z,f) => { return f.props["pmap:kind"] === "railway" },
            minzoom:14
        },
        {
            dataLayer: "transit",
    ...
    let label_rules:LabelRule[] = [
        {
            ...
            filter: (z,f) => { return f.props["pmap:kind"] == "country" }
        },
        {
            dataLayer: "places",
            symbolizer: new CenteredTextSymbolizer({
            ...
            filter: (z,f) => { return f.props["pmap:kind"] == "state" }
        },
        {
            dataLayer: "places",
            ...
            filter: (z,f) => { return f.props["pmap:kind"] == "city" },
            maxzoom:8
        },
        {
            dataLayer: "places",
